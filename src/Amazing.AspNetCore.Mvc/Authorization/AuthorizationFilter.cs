...
namespace Amazing.AspNetCore.Mvc.Authorization
{
    public class AuthorizationFilter : IAuthorizationFilter, IAsyncAuthorizationFilter
    {
        ...
        private void Check(AuthorizationFilterContext context)
        {
            ...
            if (isRequired)
            {
                ...
                if (controllerAuthorizeCheckAttribute != null && !principal.HasClaim(AmazingConstants.ClaimTypes.Permission, controllerAuthorizeCheckAttribute.Permission))
                {
                ...
                else
                {
                    ...
                    if (actionAuthorizeCheckAttribute != null && !principal.HasClaim(AmazingConstants.ClaimTypes.Permission, actionAuthorizeCheckAttribute.Permission))
                    {
                        context.Result = new ForbidResult();
                    }
                }
